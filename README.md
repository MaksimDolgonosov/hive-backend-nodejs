...
**Важно:** MongoDB в Docker слушает порт **27018**, а не стандартный 27017. Это сделано намеренно — на Windows часто уже установлена локальная служба MongoDB на порту 27017, и из‑за конфликта Compass/API подключались бы не к тому серверу.
